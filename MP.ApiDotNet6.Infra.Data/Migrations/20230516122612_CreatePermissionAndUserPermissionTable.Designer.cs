...
namespace MP.ApiDotNet6.Infra.Data.Migrations
{
    ...
    [Migration("20230516122612_CreatePermissionAndUserPermissionTable")]
    partial class CreatePermissionAndUserPermissionTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MP.ApiDotNet6.Domain.Entities.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MP.ApiDotNet6.Domain.Entities.UserPermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("MP.ApiDotNet6.Domain.Entities.UserPermission", b =>
                {
                    b.HasOne("MP.ApiDotNet6.Domain.Entities.Permission", "Permission")
                        .WithMany("UserPermissions")
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MP.ApiDotNet6.Domain.Entities.User", "User")
                        .WithMany("UserPermissions")
